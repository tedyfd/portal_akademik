                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="semester" id="semester" class="form-control">
                                        ...
                                        <?php if ($row['id_semester'] == $semester['id_semester']) : ?>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="matpel" id="matpel" class="form-control">
                                        ...
                                        <?php if ($row['id_th_matpel'] == $semester['id_th_matpel']) : ?>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nilai_p" name="nilai_p"
                                        value="<?= $semester['nilai_p'] ?>" placeholder="Nilai Pengetahuan">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nilai_k" name="nilai_k"
                                        value="<?= $semester['nilai_k'] ?>" placeholder="Nilai Keterampilan">
                                    <?= form_error('nilai_k', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="form-control-label" for="nilai_s">Nilai Semester</label>
                                    <input type="text" class="form-control" id="nilai_s" name="nilai_s"
                                        value="<?= $semester['nilai_s'] ?>" placeholder="Nilai Mid">
                                    <?= form_error('nilai_s', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                            </div>
                        </div>
                        <div class="row">
