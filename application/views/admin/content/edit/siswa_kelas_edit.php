        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="">
                    <input type="hidden" name="id" id="id" value="<?= $siswa_kelas['id_th_kelas_siswa'] ?>">
                    <div class="pl-lg-4">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="siswa">Nis</label>
                                    <select name="siswa" id="siswa" class="form-control">
                                        <?php foreach ($list_siswa as $row) : ?>
                                        <?php if ($row['nis'] == $siswa_kelas['nis']) : ?>
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="ta_kelas" id="ta_kelas" class="form-control">
                                        ...
                                        <?php if ($row['id_th_kelas'] == $siswa_kelas['id_th_kelas']) : ?>
                                        <option value="<?= $row['id_th_kelas'] ?>" selected>
                                            <?= $row['th_ajaran'] . " - " . $row['kelas'] ?>
                                        </option>
                                        <?php else : ?>
